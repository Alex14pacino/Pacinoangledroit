...
function UserDetail({ id, onChanged, close }) {
  ...
  return <>
    ...
    <div className="tiles" style={{ textAlign: 'left' }}>
      ...
      <div className="tile"><div className="l">Routines</div><div className="v" style={{ fontSize: '1.1rem' }}>{(d.plans || []).reduce((n, p) => n + (p.routines?.length || 0), (d.routines || []).length)}</div></div>
