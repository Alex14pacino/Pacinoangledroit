...
// The Firebase build has no push server, so the rest-timer alert is local-only (it fires while
// the tab is alive). These stay as no-ops to keep the timer call sites unchanged.
const pushRestTimer = () => {}
