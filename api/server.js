...
// Workout-day reminders were removed with the switch to a sequence-based rotation (no fixed
// weekday means no "planned today" to remind about). Only rest-timer push remains.
